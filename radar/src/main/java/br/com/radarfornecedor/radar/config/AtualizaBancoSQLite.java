...
public class AtualizaBancoSQLite implements ApplicationRunner {
    ...
    private void executarAtualizacoes() {
        ...
        aplicarAtualizacao(27, "Adiciona endereco e geolocalizacao em Representantes e Clientes", () -> {
            adicionarColunaSeNaoExistir("Representantes", "Logradouro",   "TEXT");
            adicionarColunaSeNaoExistir("Representantes", "Numero",       "TEXT");
            adicionarColunaSeNaoExistir("Representantes", "Complemento",  "TEXT");
            adicionarColunaSeNaoExistir("Representantes", "Bairro",       "TEXT");
            adicionarColunaSeNaoExistir("Representantes", "Cidade",       "TEXT");
            adicionarColunaSeNaoExistir("Representantes", "Estado",       "TEXT");
            adicionarColunaSeNaoExistir("Representantes", "Cep",          "TEXT");
            adicionarColunaSeNaoExistir("Representantes", "Latitude",     "REAL");
            adicionarColunaSeNaoExistir("Representantes", "Longitude",    "REAL");

            adicionarColunaSeNaoExistir("Clientes", "Logradouro",  "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "Numero",      "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "Complemento", "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "Bairro",      "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "Cidade",      "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "Estado",      "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "Cep",         "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "Latitude",    "REAL");
            adicionarColunaSeNaoExistir("Clientes", "Longitude",   "REAL");
        });

        aplicarAtualizacao(28, "Adiciona colunas Email, Telefone, Endereco, Foto, FotoNome em Clientes", () -> {
            adicionarColunaSeNaoExistir("Clientes", "Email",     "VARCHAR(100)");
            adicionarColunaSeNaoExistir("Clientes", "Telefone",  "VARCHAR(20)");
            adicionarColunaSeNaoExistir("Clientes", "Endereco",  "VARCHAR(500)");
            adicionarColunaSeNaoExistir("Clientes", "Foto",      "TEXT");
            adicionarColunaSeNaoExistir("Clientes", "FotoNome",  "VARCHAR(255)");
        });

        aplicarAtualizacao(29, "Adiciona colunas Email, Telefone, Foto, FotoNome em Fornecedores", () -> {
            adicionarColunaSeNaoExistir("Fornecedores", "Email",    "VARCHAR(100)");
            adicionarColunaSeNaoExistir("Fornecedores", "Telefone", "VARCHAR(20)");
            adicionarColunaSeNaoExistir("Fornecedores", "Foto",     "TEXT");
            adicionarColunaSeNaoExistir("Fornecedores", "FotoNome", "VARCHAR(255)");
        });
